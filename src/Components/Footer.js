...
const Footer = () => {
  return (
    <div>
   <footer className="mt-10 text-center bg-gray-900 text-white">
      ...
      <form action="">
        <div className="grid md:grid-cols-3 gird-cols-1 gap-4 flex justify-center items-center">
          ...
          <div className="md:mr-auto mb-6">
            <button type="submit" className="inline-block px-6 py-2 border-2 border-red-600 text-white font-medium text-xs leading-tight uppercase rounded hover:bg-red-800 hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
              Subscribe
            </button>
          </div>
        </div>
    ...
    <div className="grid lg:grid-cols-4 md:grid-cols-2">
      ...
      <div className="mb-6">
        ...
        <ul className="list-none mb-0">
          ...
          <li>
            <a href="#!" className="text-white">Yoga</a>
          </li>
          <li>
            <a href="#!" className="text-white">Nutritious Diet</a>
          </li>
          <li>
            <a href="#!" className="text-white">Cardio training</a>
          </li>
        </ul>
      </div>
...
backgroundColor: 'rgba(0, 0, 0, 0.2)'
    ...
    >
    <a className="text-white" >Fit-Peeps © 2022 Copyright</a>
  </div>
</footer>
